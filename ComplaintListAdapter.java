...
public class ComplaintListAdapter extends ArrayAdapter<Complaint_List> {
    ...
    public ComplaintListAdapter(@NonNull Context context, int resource, @NonNull List<Complaint_List> items) {
