...
public class FeedbackListAdapter extends ArrayAdapter<Feedbacks> {
    private LayoutInflater inflater;    // inflater used to access the views of a layout
    private int resourceId;
public FeedbackListAdapter(@NonNull Context c, int r, @NonNull List<Feedbacks> i){
    super(c,r,i);
...
//        return super.getView(position, convertView, parent);
        ...
        //
        Feedbacks x = this.getItem(position);
        fdbk.setText(x.fdbk);
