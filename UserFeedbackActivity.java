    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnFbSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                System.out.println(user_homepageActivity.globalCounter+ "@UserFeedbackActivity- button Submit was pressed");
                ...
                Intent i = new Intent(UserFeedbackActivity.this, user_homepageActivity.class);
                startActivity(i);
        ...
        btnFbHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                System.out.println(user_homepageActivity.globalCounter+ "@UserFeedbackActivity- button Home was pressed");
